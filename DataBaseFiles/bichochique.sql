...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 29-Ago-2023 às 14:47
...
CREATE TABLE IF NOT EXISTS `animais_has_proprietarios` (
  ...
  `animais_tipos_animais_id` int NOT NULL,
  `proprietarios_id` int NOT NULL,
  PRIMARY KEY (`animais_id`,`animais_tipos_animais_id`,`proprietarios_id`),
  KEY `fk_animais_has_proprietarios_proprietarios1_idx` (`proprietarios_id`),
  KEY `fk_animais_has_proprietarios_animais1_idx` (`animais_id`,`animais_tipos_animais_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `animais_has_proprietarios`
  ADD CONSTRAINT `fk_animais_has_proprietarios_animais1` FOREIGN KEY (`animais_id`,`animais_tipos_animais_id`) REFERENCES `animais` (`id`, `tipos_animais_id`),
