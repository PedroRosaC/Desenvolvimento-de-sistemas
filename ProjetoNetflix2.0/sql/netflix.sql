...
CREATE TABLE `filme` (
  ...
  CONSTRAINT `fk_filme_categoria1` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`),
  CONSTRAINT `fk_filme_perfis1` FOREIGN KEY (`perfis_id`) REFERENCES `perfis` (`id`)
...
-- Dump completed on 2023-10-25 10:17:16
